...
# Process normal_trimmed separately - SKIPPED due to missing bbox annotations
# Commenting out normal_trimmed processing to avoid FileNotFoundError
# for item in tqdm(os.listdir(os.path.join(video_path, 'normal_trimmed'))):
#     ori_time = item
#     item = f'normal_trimmed/{item}'
#     for view in ['overhead', 'vehicle']:
#         current_view = os.path.join(video_path, item, f'{view}_view')
#         if not os.path.exists(current_view):
#             continue
#
...
print("Skipping normal_trimmed processing due to missing bbox annotations")
