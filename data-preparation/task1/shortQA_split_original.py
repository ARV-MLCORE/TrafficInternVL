...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='Qwen', help='Choose your LLM')
    parser.add_argument('--api-key', type=str,default='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', help='Your API key for chosen LLM')
