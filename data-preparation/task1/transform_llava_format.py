...
parser.add_argument('--output-tag', type=str, default='', help='A tag to add to the output filename, e.g., "local"')
...
output_filename = f"wts_bdd{tag_part}_{args.split}.json"

print(f"Saving processed annotations to: {output_filename}") # เพิ่ม print เพื่อความชัดเจน
with open(os.path.join(args.save_folder, output_filename), 'w+') as f:
